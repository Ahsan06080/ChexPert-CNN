...
class Classifier(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.cam_attention64  = CAModule(64)
        self.cam_attention128  = CAModule(128)
        self.cam_attention256  = CAModule(256)
        self.cam_attention512  = CAModule(512)
    ...
    def forward(self, x):
        ...
        x0 = self.cam_attention64(x0)
        
        x1 = self.dense_block1(x0)
        x1 = self.trans_block1(x1)
        x1 = self.cam_attention128(x1)

        
        x2 = self.trans_block2(self.dense_block2(x1))
        x2 = self.cam_attention256(x2)
        
        x3 = self.trans_block3(self.dense_block3(x2))
        x3 = self.cam_attention512(x3)
