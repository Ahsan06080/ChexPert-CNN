...
from model.classifier_FeedBack import Classifier,Classifier2  # noqa
...
def train_epoch(summary, summary_dev, cfg, args, model,conv_ae, dataloader,
    ...
    for step in range(steps):
        ...
        output, logit_maps = conv_ae(image,x_b)

        # different number of tasks
        loss = 0
        loss_FE = F.binary_cross_entropy_with_logits(x_b, logit_maps.detach())
